...
|
*/
Route::match(['get','post'],'/oauth/token' , 'UserApiController@authenticate');

// Route::match(['get','post'],'/signup', function(){ echo "ndmjbhnds"; });
Route::match(['get','post'],'/signup' , 'UserApiController@signup');
// Route::match(['get','post'],'/oauth/token' , 'UserApiController@authenticate');
