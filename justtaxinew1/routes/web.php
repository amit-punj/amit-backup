...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::get('/provider/user_edit_docs/{user}', 'ProviderResources\DocumentController@user_doc_edit');
    Route::get('/provider/vehicle_document_update/{provider_id}/{id}', 'ProviderResources\DocumentController@vehicle_document_update');
    Route::match(['get','post'],'/provider/admin_provider_doc', 'ProviderResources\DocumentController@admin_provider_doc');
    Route::match(['get','post'],'/provider/vehicle/admin_vehicle_doc', 'ProviderResources\DocumentController@admin_vehicle_doc');
    Route::get('/provider/provider_account/{provider}', 'Resource\ProviderResource@providerAccount');
    Route::get('/user/user_account/{user}', 'Resource\UserResource@userAccount');
});
