		...
		<ul class="sidebar-menu">
			...
			<li class="with-sub">
				...
				<ul> -->
					...
					<!-- <li><a href="{{ route('admin.ride.statement.all') }}">@lang('admin.include.overall_ride_statments')</a></li> -->
			...
			<li>
				<a href="{{ route('admin.ticket.index') }}" class="waves-effect  waves-light">
					<span class="s-icon"><i class="ti-infinite"></i></span>
					<span class="s-text">@lang('admin.include.support')</span>
				</a>
			</li>
			...
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					<span class="s-caret"><i class="fa fa-angle-down"></i></span>
					<span class="s-icon"><i class="ti-view-grid"></i></span>
					<span class="s-text">@lang('admin.include.area_service_type')</span>
				</a>
				<ul>
					<li><a href="{{ route('admin.areaservice.index') }}">@lang('admin.include.area_list_service_types')</a></li>
					<li><a href="{{ route('admin.areaservice.create') }}">@lang('admin.include.area_add_new_service_type')</a></li>
				</ul>
			</li>
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
			...
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					<span class="s-caret"><i class="fa fa-angle-down"></i></span>
					<span class="s-icon"><i class="ti-layout-tab"></i></span>
					<span class="s-text">@lang('admin.include.quests')</span>
				</a>
				<ul>
					<li><a href="{{ route('admin.quest.index') }}">@lang('admin.include.list_quests')</a></li>
					<li><a href="{{ route('admin.quest.create') }}">
					@lang('admin.include.add_new_quest')</a></li>
				</ul>
			</li>
			...
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					<span class="s-caret"><i class="fa fa-angle-down"></i></span>
					<span class="s-icon"><i class="ti-view-grid"></i></span>
					<span class="s-text">@lang('admin.include.Help_support')</span>
				</a>
				<ul>
					<li><a href="{{ route('admin.category.index') }}">@lang('admin.include.category')</a></li>
					<li><a href="{{ route('admin.faq.index') }}">@lang('admin.include.faq')</a></li>
				</ul>
			</li>

			<li>
				<a href="{{ route('admin.referrals.index') }}" class="waves-effect  waves-light">
					<span class="s-icon"><i class="ti-palette"></i></span>
					<span class="s-text">@lang('admin.include.referrals')</span>
				</a>
			</li>
			...
			<li>
				<a href="{{ route('admin.TermsANDConditions') }}" class="waves-effect waves-light">
					<span class="s-icon"><i class="ti-help"></i></span>
					<span class="s-text">@lang('admin.include.TermsANDConditions')</span>
				</a>
			</li>
