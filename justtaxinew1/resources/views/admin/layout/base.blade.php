...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('main/assets/css/select2.min.css') }}">
...
<body class="fixed-sidebar fixed-header content-appear skin-default">
    ...
    <script type="text/javascript" src="{{asset('main/assets/js/select2.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('main/assets/js/jquery.validate.js')}}"></script>
...
<script src="https://maps.googleapis.com/maps/api/js?key={{Setting::get('map_key')}}&libraries=places&callback=initAutocomplete"></script>
</body>
</html>