        ...
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{ route('admin.areaservice.edit.servicetype', [$service->id,$area_id]) }}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ $service->night_charges }}" name="night_charges" required id="night_charges" placeholder="Night Charges">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ $service->airport_charges }}" name="airport_charges" required id="airport_charges" placeholder="Airport Charges">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ $service->cancellation_fee }}" name="cancellation_fee" required id="cancellation_fee" placeholder="Cancellation Fee">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ $service->platform_fee }}" name="platform_fee" required id="platform_fee" placeholder="Platform Usage Fee/Commission">
                    </div>
                </div>
