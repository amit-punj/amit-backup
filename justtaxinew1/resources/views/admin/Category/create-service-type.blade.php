        ...
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.areaservice.create.servicetype',$id)}}" method="POST" enctype="multipart/form-data" role="form">
                    ...
                    <div class="col-xs-10">
                        <select class="form-control" required="" id="name" name="name">
                            ...
                            @foreach($services as $service)
	                			<option value="{{$service->id}}" <?php if(in_array($service->id, $added_services) ) echo "disabled"; ?>>{{ $service->name }} </option>
	                		@endforeach
                            @endif
		                </select>
                    </div>
                ...
                <div class="form-group row" id="hour_price" style="display: none;">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" min="0" value="{{ old('fixed',0) }}" name="hour" id="hourly_price" placeholder="Set Hour Price">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" min="0" value="{{ old('fixed') }}" name="fixed" required id="fixed" placeholder="Base Price">
                    </div>
                </div>
                <!-- Base distance -->
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" min="0" value="{{ old('distance') }}" name="distance" required id="distance" placeholder="Base Distance">
                    </div>
                </div>
                <!-- unit time pricing -->
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" min="0" value="{{ old('minute') }}" name="minute" required id="minute" placeholder="Unit Time Pricing">
                    </div>
                </div>
                <!-- unit distance price -->
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" min="0" value="{{ old('price') }}" name="price" required id="price" placeholder="Unit Distance Price">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" min="0" value="{{ old('night_charges') }}" name="night_charges" required id="night_charges" placeholder="Night Charges">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" min="0" value="{{ old('airport_charges') }}" name="airport_charges" required id="airport_charges" placeholder="Airport Charges">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" min="0" value="{{ old('cancellation_fee') }}" name="cancellation_fee" required id="cancellation_fee" placeholder="Cancellation Fee">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" min="0" value="{{ old('platform_fee') }}" name="platform_fee" required id="platform_fee" placeholder="Platform Usage Fee/Commission">
                    </div>
                </div>
