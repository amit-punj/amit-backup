        ...
        <div class="container-fluid">
            <div class="box box-block bg-white">
            	...
            	<div style="text-align: center;padding: 20px;color: blue;font-size: 24px;">
            		<p><strong>
            			<span>Over All Earnings : {{currency($revenue[0]->overall)}}</span>
            			<br>
            			<span>Over All Commissions : {{currency($revenue[0]->commission)}}</span>
            		</strong></p>
            	</div>
            	...
            	<div class="row">
					...
					<div class="col-lg-4 col-md-6 col-xs-12">
						<div class="box box-block bg-white tile tile-1 mb-2">
							...
							<div class="t-content">
								<h6 class="text-uppercase mb-1">Total Star Rating</h6>
								<h1 class="mb-1">0</h1>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-xs-12">
						<div class="box box-block bg-white tile tile-1 mb-2">
							...
							<div class="t-content">
								<h6 class="text-uppercase mb-1">Total Online Time</h6>
								<h1 class="mb-1">0</h1>
							</div>
						</div>
					</div>
