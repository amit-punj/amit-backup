...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            <a href="{{ route('admin.areaservice.show',$area_id) }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> @lang('admin.back')</a>

            <h5 style="margin-bottom: 2em;">@lang('admin.areaservice.Update_Service_Type')</h5>

            <form class="form-horizontal" action="{{ route('admin.areaservice.edit.servicetype', [$service->id,$area_id]) }}" method="POST" enctype="multipart/form-data" role="form">
                {{csrf_field()}}
                        ...
                        <select class="form-control" required="" id="name" name="name">
                            <option value="" disabled selected>Select Vehicle Type</option>
                                ...
                                @foreach($services as $getService)
                                    <option value="{{$getService->id}}" {{($service->name == $getService->id ) ? "selected" : 'disabled' }}>{{ $getService->name }} </option>
                                @endforeach
                                @endif
                        </select>
                    </div>
                ...
                @endif
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" min="0" value="{{ $service->hour }}" name="hour" required id="hourly_price" placeholder="Set Hour Price">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" min="0" value="{{ $service->fixed }}" name="fixed" required id="fixed" placeholder="Base Price">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" min="0" value="{{ $service->distance }}" name="distance" required id="distance" placeholder="Base Distance">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" min="0" value="{{ $service->minute }}" name="minute" required id="minute" placeholder="Unit Time Pricing">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" min="0" value="{{ $service->price }}" name="price" required id="price" placeholder="Unit Distance Price">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" min="0" value="{{ $service->night_charges }}" name="night_charges" required id="night_charges" placeholder="Night Charges">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" min="0" value="{{ $service->airport_charges }}" name="airport_charges" required id="airport_charges" placeholder="Airport Charges">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" min="0" value="{{ $service->cancellation_fee }}" name="cancellation_fee" required id="cancellation_fee" placeholder="Cancellation Fee">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" min="0" value="{{ $service->platform_fee }}" name="platform_fee" required id="platform_fee" placeholder="Platform Usage Fee/Commission">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <a href="{{route('admin.areaservice.show',$area_id)}}" class="btn btn-danger btn-block">@lang('admin.cancel')</a>
                    </div>
                </div>
            </form>
        </div>
