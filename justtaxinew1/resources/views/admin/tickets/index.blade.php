                ...
                <tbody>
                    ...
                    <tr>
                       ...
                       <!--  @if(Setting::get('demo_mode', 0) == 1)
                        ...
                        <td>
                            @if($ticket->role == 'user')
                                {{ $ticket->user_issue->first_name }} {{ $ticket->user_issue->last_name }}
                            @elseif($ticket->role == 'provider')
                                {{ $ticket->provider_issue->first_name }} {{ $ticket->provider_issue->last_name }}
                            @endif
                        </td>
                        <td>{{ $ticket->status }}</td>
                        <td>
                            ...
                            @if( Setting::get('demo_mode') == 0)
                                <a href="{{ route('admin.ticket.show', [$ticket->id]) }}"><span class="btn btn-success btn-large">View</span></a>
                            @endif
                            </div>
                        </td>
                    </tr>
