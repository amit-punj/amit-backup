...
class ProviderService extends Model
{
     ...
     */
    protected $fillable = [
        'service_type_id', 'provider_id','service_model','service_number','chassis_number','status','service_type_id','prime','active_status'
    ];
    ...
    public function active_vehicle_document()
    {
        return $this->hasMany('App\ProviderVehicleDocument','vehicle_id')->where('status', 'ACTIVE')->count();
    }
}
