...
class AccountResource extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            return redirect()->route('admin.account-manager.index')->with('flash_success','Admin Details Saved Successfully');
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('admin.account-manager.index')->with('flash_success', 'Admin Details Updated Successfully');    
        } 
