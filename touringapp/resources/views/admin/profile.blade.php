    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <!-- START WIDGETS -->
                    <form action='{{ url("admin/profile") }}'   class="form-horizontal" method="post" role="form" id="create_formmcc" >
                    {{ csrf_field() }}
                    ...
                    <!-- <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <select type="text" name="role" class="form-control" id="create_role">
                                 <option value="10" {{ ($user->role == 10)?'selected':''}} >Simple Agent</option> 
                            </select>
                            @if ($errors->has('role'))
                                <span class="help-block">
                    ...
                    <div class="form-group">
                        <label for="Password" class="col-md-2 required">Old Password</label>
                        <div class="col-md-10">
