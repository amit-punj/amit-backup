        ...
        <div class="col-md-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <!-- <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <select type="text" name="role" class="form-control" id="create_role">
                                <option value="1" @if(old("role") == "1") selected="selected" @endif >Admin</option> 
                                 <option value="10" @if(old("role") == "10") selected="selected" @endif >Client</option> 
                            </select>
                            @if ($errors->has('role'))
                                <span class="help-block">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <select type="text" name="company" class="form-control" id="company">
                                <option value="no" @if(old("company") == "no") selected="selected" @endif >No</option> 
                                <option value="yes" @if(old("company") == "yes") selected="selected" @endif >Yes</option>
                            </select>
                    ...
                    <div class="extra_field_show_hide company_details" style="display: none;">
                        ...
                        <div class="form-group company_details" style="margin-bottom: 15px;">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="company_vat" class="form-control"  placeholder="Comapny VAT"/>
