            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" id="top" name="top" class="form-control" value="30.716665"  placeholder="Top"/>
                            @if ($errors->has('top'))
                                <span class="help-block">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" id="right" name="right" class="form-control" value="76.853813" placeholder="Right"/>
                            @if ($errors->has('right'))
                                <span class="help-block">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" id="bottom" name="bottom" class="form-control" value="30.713088" placeholder="Bottom"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" id="left" name="left" class="form-control" value="76.844801" placeholder="Left"/>
                            @if ($errors->has('left'))
                                <span class="help-block">
...
var minimum_zoom;
var maximum_zoom;   
    function updateVariations(add_poi)
    {   
        var html= '';
        $('.variation_list').each(function (index) {
            ...
            html = '<input type="text" name="v['+add_poi+'_'+id+']" value="'+name+'" id="v_name_'+add_poi+'_'+id+'" class="form-control poi_id_'+add_poi+'" />';
            content = '<textarea name="editor['+add_poi+'_'+id+']" class="poi_id_'+add_poi+'" id="editor_'+add_poi+'_'+id+'"></textarea>';
            $('#content_'+add_poi+'').append(content);
            CKEDITOR.replace( 'editor['+add_poi+'_'+id+']' );
            $('#v_type_'+add_poi+'').append(html);
        });
        // console.log(content);
        // $('.variation_type').html(html);
        // $('.v_type').html(html);
    }
    function update_variation_drop()
    {
        var html = "";
        $('.variation_list').each(function (index) {
            var id      = $( this ).attr('data-id');
    ...
    {   
        var html= '';
        var content= '';
        $('.ck_editor_list').each(function (index) {
            var name    = $( '#variation_list_'+id+'' ).attr('data-name');
            var add_poi = $(this).val();
            html = '<input type="text" name="v['+add_poi+'_'+id+']" value="'+name+'" id="v_name_'+add_poi+'_'+id+'" class="form-control" />';
            content = '<textarea name="editor['+add_poi+'_'+id+']" id="editor_'+add_poi+'_'+id+'"></textarea>';
            $('#v_type_'+add_poi+'').append(html);
            $('#content_'+add_poi+'').append(content);
            CKEDITOR.replace( 'editor['+add_poi+'_'+id+']' );
        });
    ...
    {   
        $('.ck_editor_list').each(function (index) {
            var name    = $( '#variation_list_'+id+'' ).attr('data-name');
            var add_poi = $(this).val();
           $('#editor_'+add_poi+'_'+id+'').remove();
           $('#pic_'+add_poi+'_'+id+'').remove();
           $('#cke_editor_'+add_poi+'_'+id+'').remove();
           $('#v_name_'+add_poi+'_'+id+'').remove();
...
function addRow()
    {
        ...
        html +='       <a href="javascript:void(0)" id="add'+add_row+'" title="Add New" onclick="javascript:add_new('+add_row+')" class=" btn btn-success"><i class="fa fa-save" aria-hidden="true"></i></a>';
        // html +='       <a href="javascript:void(0)" onclick="javascript:EditRow('+add_row+')"class=" btn btn-primary"><i class="fa fa-edit"></i></a>';
        html +='       <a href="javascript:void(0)" title="Delete" onclick="javascript:RemoveRow('+add_row+')" class=" btn btn-danger"><i class="fa fa-trash"></i></a>'; 
        html +='    </div>';
        html +=' </div>';
...
function AddPoi()
    {
        ...
        html +='      <input type="hidden" name="poi_id['+add_poi+']" id="poi_id_'+add_poi+'" value="poi_id'+add_poi+'">';
        html +='              <div class="col-md-12" id="main_poi_'+add_poi+'" style="display: flex;margin-bottom:5px;">';
        html += '<input type="hidden" class="ck_editor_list" name="ck_editor['+add_poi+']" id="ck_editor_id_'+add_poi+'" value="'+add_poi+'">'; 
        ...
        html +='        <select type="text"  name="variation_type['+add_poi+']" style="display:none;" id="variation_type_'+add_poi+'" class="variation_type" >';
        html +='        </select>';
        html +='                    <div class="col-md-3 v_type" id="v_type_'+add_poi+'">';
        html +='                    </div>';
        ...
        html +='                    <a href="javascript:void(0)" title="Delete" onclick="javascript:RemovePoi('+add_poi+')" class=" btn btn-danger"><i class="fa fa-trash"></i></a>';
        html +='                    </div>';
        html +='                </div>';
        html +='          </div><br>';
    ...
    function select_content(add_poi)
    {
        var val = jQuery("#content_type_"+add_poi+"").val();
        var html = "";
            $('.variation_list').each(function (index) {
                var id      = $( this ).attr('data-id');
                if(val == 'text')
                {
                    // html +='<textarea name="editor['+add_poi+']" id="editor_'+add_poi+'"></textarea>';
                    html += '<textarea name="editor['+add_poi+'_'+id+']" id="editor_'+add_poi+'_'+id+'"></textarea>';
                    $("#content_"+add_poi+"").html('');
                    $("#content_"+add_poi+"").append(html);
                ...
                {
                    html +='<input type="file" onchange="javascript:image_upload('+add_poi+')" multiple name="pic['+add_poi+'_'+id+']" id="pic_'+add_poi+'_'+id+'" >';
                    $("#content_"+add_poi+"").html('');
                    $("#content_"+add_poi+"").append(html);
                }
            });
