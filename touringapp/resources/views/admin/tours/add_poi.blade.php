    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <!-- START WIDGETS -->
                    <form  action='{{ url("admin/tours/{$tour->id}/add_poi") }}' class="form-horizontal" method="post" role="form" id="create_formmcc" enctype="multipart/form-data" >
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" id="poi_name" name="poi_name" class="form-control"  placeholder="Poi Name"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <select type="text" name="icon_type" id="icon_type" class="form-control icon_type" >
                                    <option value="icon1" data-class="avatar" data-style= "background-image: url('{{ asset('images/d1.png') }}');" >Icon 1</option>
                                    <option value="icon2" data-class="avatar" data-style= "background-image: url('{{ asset('images/d2.png') }}');" >Icon 2</option> 
                                    <option value="icon3" data-class="avatar" data-style= "background-image: url('{{ asset('images/d3.png') }}');" >Icon 3</option> 
                                    <option value="icon4" data-class="avatar" data-style= "background-image: url('{{ asset('images/d4.png') }}');" >Icon 4</option> 
                                </select>
                            ...
                            @foreach($variation_details as $variation)
                                <div class="row flex" id="poi_div" style="margin-bottom: 15px;">
                                    ...
                                    <div class="col-md-8 content" id="content_{{$variation->id}}">
                                        <textarea class="editor" name="editor_{{$variation->id}}" id="editor_{{$variation->id}}"> 
...
<script type="text/javascript">
    ...
    function select_content()
    {
        ...
        $('.variation_list').each(function (index) {
            ...
            {
                html='<textarea id="video_'+id+'" rows="3"  name="video_'+id+'" class="form-control"  placeholder="Enter Vimeo embed code"/></textarea>';
                $("#content_"+id+"").html(html);
            }
