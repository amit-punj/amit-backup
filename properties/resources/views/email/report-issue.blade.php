													...
													<tr>
														<td valign="top">
															<div id="body_content_inner">
																<h1>Hi, Admin</h1>
																<p>Issue for : <strong>{{ $title }}</strong></p>
																<p>Reason : <strong>{{ $reason }}</strong></p>
																<!-- <p>Comment : <strong>{{ $comment }}</strong></p> -->
																@if($filename)
																<img src='{{ asset("issues/{$filename}") }}' style="float: left;color: black;text-align: center;text-decoration: none;font-size: 18px; line-height: 25px;border-radius: 4px;width: 100px;height: 100px">
																@endif
															</div>
														</td>
													</tr>
