    ...
    <div class="row m-0">
        ...
        <div class="col-md-9 setmd">
            <div class="property">
                ...
                @endif
                <div class="form">
                 <div class="note"><p style="font-size: 22px;">Import <span style="color: #41ac1b"> Your </span> Requirements CSV</p>
                </div>
                </div>
                <div class="form-content ">
                    <div class="card-body">
                        <form action="{{ url('import-requirement') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="file" name="file" class="form-control">
                            <br>
                            <button class="btn btn-success">Import Requirements Data</button>
