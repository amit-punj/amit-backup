    ...
    <div class="row my-4">
        ...
        <div class="row my-4">
          <div class="col-md-12 col-sm-12 col-12">
            <div class="f25 f300 color-gray">
              <i class="fa fa-minus color-orange" aria-hidden="true"></i> Buyers search
            </div>
            <form id="mainSearch_form" action="{{url('agent/requirement-advance_search')}}" method="get">
            @csrf
              <div class="form-group">
                ...
                <input id="autocomplete" name="search" class="form-control autocomplete" placeholder="Enter your address" value="{{ $city_prefil }}" type="text"/>
              </div>
               <div class="form-group">
             ...
             <!--  <div class="form-group">
              ...
              <div class="form-group">
                <select name="property_type" class="form-control color-gray">
                  ...
                  <option value="industrial"  <?php if($property_type == 'industrial') echo "selected"; ?>>Industrial</option>
                  <option value="land" <?php if($property_type == 'land') echo "selected"; ?>>Land</option>
                </select>
              </div>
              <div class="form-group">
                <select name="purpose" class="form-control color-gray">
                  <option value="">Purpose</option>
                  <option value="buy" <?php if($purpose == 'buy') echo "selected"; ?>>Buy</option>
                  <option value="rent" <?php if($purpose == 'rent') echo "selected"; ?>>Rent</option>
                  <!-- <option value="lease">Lease</option> -->
                </select>
              </div>
          <div class="row">    
              <div class="form-group col-md-12">
                <input type="number" min="1" class="form-control" name="min_price" value="{{ old('min_price',$min_price)}}" placeholder="Price">
              </div>
              <div class="form-group col-md-12">
               <input type="number" min="1" max="150" class="form-control" name="min_room" value="{{ old('min_room',$min_room)}}" placeholder="Rooms">
              </div>
              <div class="form-group col-md-12">
                 <input type="number" min="1" max="40" name="min_bathroom" class="form-control" value="{{ old('min_bathroom',$min_bathroom) }}" placeholder="Bathrooms">
              </div>
          </div>    
              <div class="form-group">
                                <div class="label"><span style="font-weight: bold;">1031 exchange property</span>
                                ...
                                <div class="radioOptions" style="width: 100%;margin-top: 7px;">
                                    <label class="radio-inline">
                                        <input type="radio" name="exchange" class="" value="yes" <?php if($exchange == 'yes') echo "checked"; ?>>Yes
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="exchange" class="" value="no" <?php if($exchange == 'no') echo "checked"; ?>>No
                                    </label>
                                </div>
              </div>
              <div class="form-group">
                                <div class="label"><span style="font-weight: bold;">All Cash</span>
      ...
      <div class="col-lg-8 col-md-12">
                <div class="row">
                 ...
                 @endif
                   <div class="note"><p style="font-size: 22px;"> Buyers <span style="color: #41ac1b"> Search </span> List </p>
                  </div>
                  </div>
                </div>
                  ...
                  <div class="p-1 ">
                        ...
                        <div class="row bg-color color-gray p-3">
                          ...
                          <div class="col-md-12 col-sm-12 mb-1">
                            <div class="f25 ">
                              <span class="color-gray f15 float-center">{{$property->title}}
                              </span>
                            </div>
                            <div class="f18 f700">{{ number_format($property->min_price,2) }} - 
                                {{ number_format($property->max_price,2) }}$
                            ...
                            <div class="row f14 f300">
                              ...
                              <div class="col-md-4"> <i class="fa fa-bed color-orange" aria-hidden="true"></i> 
                                  {{ $property->min_room}} - {{ $property->max_room}}
                              </div>
                            ...
                            <div class="row btn-orange f14">
                              ...
                              <div class="col-md-4 col-6 col-sm-6 py-1">
                                <div> <i class="fa fa-bath f25" aria-hidden="true"></i> {{ $property->min_bathroom}} - {{ $property->max_bathroom}} </div>
                              </div>
                              ...
                              <div class="col-md-3 col-12 col-sm-12  py-1" style="background: #202020; text-align: center;">
                                <a href="{{url('requirement/detail/pub/'.$property->id)}}" class="color-white f15 float-center"> More Details
                                </a></div>
                            </div>
                          </div>
                        </div>
