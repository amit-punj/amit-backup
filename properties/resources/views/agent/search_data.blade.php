                    ...
                    <div class="col-md-12">
                        <nav>
                            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                <div class="col-6">
                                <a class="nav-item nav-link active" href="{{ url('agent/search_list/data')}}" role="tab" aria-controls="nav-home" aria-selected="true">Property</a>
                                </div>
                                <div class="col-6">
                                <a class="nav-item nav-link"  href="{{ url('agent/buyer/search/data')}}" role="tab">Buyers</a>
                                </div>
                            </div>
                        </nav>
                        <div class="tab-content" id="nav-tabContent">
                        <div>
        @if(count($search_data_property))
            ...
            <table class="table table-striped" id="rmhov">
                ...
                <tbody>
                        <?php $i= 1; ?>
                        @foreach($search_data_property as $data)
                            <tr>
                                <td>{{$i++}}</td>
                                ...
                                <td class="despflex">
                                 <a href="{{ $data->url }}" class="btn btn-default btn-xs" style="font-size: 17px; color: green;" ><i class="fas fa-eye"></i></a>
                                    ...
                                    <a href='{{ url("agent/delete/search/$data->id")}}' onclick="return confirm('Are you sure to delete this Proprty Listing?')"  class=" btn btn-default btn-xs" style="font-size: 17px; color: green;" title="delete"><i class="fas fa-minus-circle"></i></a>
