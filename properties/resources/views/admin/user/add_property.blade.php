...
<div class="container">
    <div class="row m-0">
     ...
     <div class="note"><p style="font-size: 22px;">Add <span style="color: #41ac1b"> Your </span> Property</p>
                ...
                <form id="form_submit" action="{{url('agent/preview/property')}}" method="post">
                  @csrf
                  <?php $ameniti = array(); ?>
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="cInput">
                                    ...
                                    <input type="text" name="title" id="title" id="text" placeholder="Title" value="{{old('title')}}" class="form-control" style="" required=""> 
                                </div>
                                @if ($errors->has('title'))
                                    <span class="help-block" style="color: red;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="cInput">
                                    ...
                                    <input type="number" name="rooms" min="1" max="50" placeholder="Bedrooms" value="{{old('rooms')}}"  class="form-control" style="" required="" >
                                </div>
                                @if ($errors->has('rooms'))
                                    <span class="help-block" style="color: red;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="cInput">
                                    ...
                                    <input type="number" name="bathroom" min="1" max="50" placeholder="Bathrooms" value="{{old('bathroom')}}"  class="form-control" style="" required="" >
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="cInput">
                                    ...
                                    <input type="number" min="0" name="size" placeholder="Size(Sq Ft)" value="{{old('size')}}"  class="form-control" style="">
                                    @if ($errors->has('size'))
                                        <span class="help-block" style="color: red;">
                            ...
                            <div class="form-group">
                                <div class="rooms" id="Additional_RoomsID">
                                    ...
                                    <div class="card-body" style="padding:0;">
                                        <div class="amenities">
                                            <p style="font-size: 16px;font-weight: 550;margin-left: 1%;">Amenities/Facilities available:<span class="error"> *</span> 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="cInput">
                                    ...
                                    <input type="text" name="city_name" id="autocomplete"  placeholder="City" value="{{old('city_name')}}" class="form-control" style=""> 
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="cInput">
                                    ...
                                    <input type="text" name="local_area" placeholder="Neighborhood" value="{{old('local_area')}}"  class="form-control" style=""> 
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="cInput">
                                    ...
                                    <textarea class="form-control" name="discription" cols="4" rows="4" style="border-radius: unset; border-left-color: #41ac1b !important;border-left-width: thick !important; background-color: #f3f3f3!important;">{{old('discription')}}</textarea>
                                </div>
                            </div>        
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-12 text-center">
                          <input type="submit" class="btnSubmit" id="btnsub" value="Next" style="margin-top: 5%; width: 50%;"> 
                          </div>
                      </div>
                      </div>
                    </div>
