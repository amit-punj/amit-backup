        ...
        <div class="container profile-page">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div  class="user-account-table">
                        ...
                        <table  class="table table-hover table-striped table-bordered">
                            ...
                            <tbody >
                                ...
                                <tr>
                                    <td >Routing code :</td>
                                    <td >{{ $account_info->routing_number }}</td>
                                </tr>
                                <tr>
                                    <td >Paypal Email :</td>
                                    <td >{{ $account_info->paypal_email }}</td>
                                </tr>
                            </tbody>
                            @else
                            <tbody >
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="edit-link"><a href="{{ url('/edit-bank-account') }}"> Edit Account </a></div>
                        </div>
                    </div>
                    @endif
                </div>
