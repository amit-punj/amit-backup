                        ...
                        <div class="tile">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ url('propertydetails/'.$task->unit_id) }}">
                                                {!! \Helper::unit_name($task->unit_id); !!}
                                            </a>
                                        </td>
                                         
                                        @if(isset($task->task_date))
                                        <td >{!! \Helper::Date($task->task_date); !!}</td>
                                        @elseif(isset($task->updated_at))
                                        <td >{!! \Helper::Date($task->updated_at); !!}</td>
                                        @else
                                        <td>--</td>
                                        @endif
                                        ...
                                        <td>
                                            <a href="{{ url('contract-details/'.$task->contract_id) }}"><span class="glyphicon glyphicon-eye-open" title="View"></span></a>
                                        </td>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $loop->index+1 }}</td>
                                        <td>
                                            <a href="{{ url('propertydetails/'.$contract->unit_id) }}"> 
                                                {{ $contract->unit['unit_name'] }} 
                                            </a>
                                        </td>
                                        <td>
                                            <a href="{{ url('tenant-details/'.$contract->tenant_id) }}">
                                                {{ $contract->user['name']." ". $contract->user['last_name']}} 
                                            </a>
                                        </td>
