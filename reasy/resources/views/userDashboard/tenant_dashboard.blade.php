                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">{{$contract->step}}</td>
                                        <td >
                                            <a class="btn btn-success" href="{{url('book-property/'.$contract->unit_id)}}">Procceed</a>
                                            <a class="btn btn-danger" onclick="return confirm('Are you sure?')" href="{{url('delete-booking/'.$contract->id)}}">Cancel</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
