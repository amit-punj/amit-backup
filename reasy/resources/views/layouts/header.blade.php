                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu class_for_mobile">
                    ...
                    @if(Auth::user()->user_role == 2)
                      <?php Session::put('main_role', 2); ?>
                    @endif
                    @if(Session::get('main_role') == 2)
                      <li><a href="{{ url('/change-role/2') }}">As PO</a></li>
                      <li><a href="{{ url('/change-role/4') }}">As PDE</a></li>
                      <li><a href="{{ url('/change-role/5') }}">As LA</a></li>
                      <li><a href="{{ url('/change-role/6') }}">As VO</a></li>
                    @endif
                    @if(Auth::user()->user_role == 2)
