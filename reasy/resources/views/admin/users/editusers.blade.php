...
@section('content')
    <main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{url('/admin/newuser')}}">Edit User</a></li>
        </ul>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            ...
            <div class="tile-body">
              <form method="post" action="{{url('/admin/updateuser')}}" id="update_user">
                @csrf
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" placeholder="Enter Last Name" name="last_name" value="{{ $user->last_name }}">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" placeholder="Enter Email" name="email" value="{{ $user->email }}" readonly="true">
                    @if ($errors->has('email'))
                       <span class="help-block" style="color: red;">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" placeholder="Enter Password" name="password" value="Admin@123">
    ...
    <script type="text/javascript">
       jQuery(document).ready(function(){
          jQuery('#user_role').val({{ $user->user_role }});
        });
      jQuery('#update_user').validate({
              errorClass:"red",
              validClass:"green",
              rules:{
                  name:{
