...
<main class="app-content">
      <div class="app-title"><h3>Meter List</h3>
       </div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
	                            ...
	                            <div class="col-sm-12">
		                            ...
		                            <div class="unit-body">
    		                                ...
    		                                <div class="unit-delete">
                                                <a class="delete btn" href="{{ url('/delete-meter/'.$meter->id) }}">delete</span></a>
                                            </div>
                                     
		                                <div class="unit-delete">
                                            <a class="btn" href="{{ url('/meter-details-admin/'.$meter->id) }}">Edit</a>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="unit-body">
                                            ...
                                            <div class="unit-delete">
                                                <a class="delete btn" href="{{ url('/delete-meter/'.$meter->id) }}">delete</a>
                                            </div>
