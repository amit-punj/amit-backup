    ...
    <table style="width: 90%; margin-left: 5%;">
        ...
        <tr>
            <td colspan="4" style="font-family: 'IBM Plex Sans'; padding: 15px 0px;">
                <p style="margin:0;">
                    {{$pm_name}} just confirm your request for unit "{{$unit_name}}"
                </p>
                <p style="margin:0;">
                    Please book a appointment with Place Description Expert.So he can complete the document formalities and hand over of the property to you.
                </p>
            </td>
        </tr>
    </table>
    <table style="width: 90%; margin-left: 5%;">
        <tr style=" background-color: rgb(40,40,40); height: 74px; align-items: center; font-size: 20px; text-align: center;">
            <td colspan="4" width="100%" style="font-family: 'IBM Plex Sans';">
                <span><a href="{{ url('book-appointment/'.$booking_id.'?type=Entry') }}">Book Appointment</a></span>
            </td>
        </tr>
    </table>
