    ...
    <table style="width: 90%; margin-left: 5%;">
        <tr>
            <td colspan="4" style="font-family: 'IBM Plex Sans';">
                <span style="font-size: 28px; color: #000;">Hi</span>
            </td>
        </tr>
        <tr>
            <td colspan="4" style="font-family: 'IBM Plex Sans'; padding: 15px 0px;">
                <p style="margin:0;">
                    <strong>{{$tenant_name}}</strong> just invited you as a co-tenant for this unit <a href="{{ url('propertydetails/'.$unit_id) }}">Click here</a> to see unit details.
                </p>
                <p style="margin:0;">
                    You can view and update your details by clicking on the below link. 
                </p>
            </td>
        </tr>
    </table>
    <table style="width: 90%; margin-left: 5%;">
        <tr style=" background-color: rgb(40,40,40); height: 74px; align-items: center; font-size: 20px; text-align: center;">
            <td colspan="4" width="100%" style="font-family: 'IBM Plex Sans';">
                <span><a href="{{ url('co-tenant-response/'.$Invitation_id.'/Yes') }}">Yes</a></span>
                <span><a href="{{ url('co-tenant-response/'.$Invitation_id.'/No') }}">No</a></span>
            </td>
        </tr>
    </table>
    <hr style="border: none; border-bottom: 1px solid rgb(61,61,61);">
