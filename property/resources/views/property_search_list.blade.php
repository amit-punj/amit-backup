                            ...
                            <div class="p-1 ">
                                <div class="row bg-color color-gray p-3">
                                    <div class="col-md-4 col-sm-6 ">
                                        <?php $url = '/images/property_banners/540X380/'.$property->cover_image; ?>
                                    ...
                                    <div class="col-md-8 col-sm-6 mb-1">
                                        ...
                                        <div class="row f14 f300">
                                            <div class="col-md-4 "> <i class="fa fa-area-chart" aria-hidden="true"></i> {{$property->area}} {{ucfirst($property->area_in)}}
                                            </div>
