    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{url('/admin/addcmspage')}}">Add Cms Page</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            ...
            <div class="tile-body">
              <form method="post" action="{{url('/admin/addcmspage')}}">
              	@csrf
                ...
                <div class="form-group">
                  ...
                  <textarea id="add_cms_content" class="form-control" name="content" rows="4" placeholder="Enter your content"></textarea>
                </div>
