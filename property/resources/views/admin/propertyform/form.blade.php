...
if(\Request::is('create-property-admin')){
...
<div class="div" id="myWizard"> 
    ...
    @if (\Request::is('edit-unit-admin/*'))
    <form autocomplete="off" method="POST" action="{{ url('/update-unit-admin/'.$unit->id) }}" enctype="multipart/form-data" id="create_propert_form">
    @elseif (\Request::is('edit-building-admin/*'))
    <form autocomplete="off" method="POST" action="{{ url('/update-building-admin/'.$property->id) }}" enctype="multipart/form-data" id="create_propert_form">
    @else
    <form autocomplete="off" method="POST" action="{{ url('/add-property-admin') }}" enctype="multipart/form-data" id="create_propert_form"> 
    @endif
        ...
        <div class="tab-content">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select name="p_type" id="p_type" class="form-control">
                                ...
                                @if ((\Request::is('create-property-admin')) && isset($_GET['building']))

                                <option value="unit">Unit</option>
                                @elseif(\Request::is('create-property-admin'))
                                <option value="unit">Unit</option>
                                <option value="building">Building</option>
                                @elseif (\Request::is('edit-unit-admin/*'))
                                <option value="unit">Unit</option>
                                @elseif (\Request::is('edit-building-admin/*'))
                                <option value="building">Building</option>
                                @endif
                      ...
                      @if(isset($_GET['building']))  
                        <input type="hidden" name="building_id_query_str" value="{{ $_GET['building'] }}">
                        @endif
                    </div> 
            ...
            <div class="tab-pane fade" id="step3">
                ...
                <div class="well">
                    ...
                    <hr>
                    <div class="form-group row">
                        <label for="deposit" class="col-md-12 col-form-label">{{ __('Amenities/Facilities available') }}</label>
...
<script type="text/javascript">
    ...
    $('.next').click(function(){
        ...
        if($(this).attr('step') == 3){
            ...
            if(posign && validator.element( "#u_type" ) && validator.element( "#rent" ) && validator.element( "#cost_provision" ) && validator.element( "#deposit" ) && validator.element( "#bedrooms" ) && validator.element( "#fixed_price" ) && validator.element( "#tax" )){
...
@if (\Request::is('edit-building-admin/*'))
<script type="text/javascript">
    jQuery(document).ready(function(){
