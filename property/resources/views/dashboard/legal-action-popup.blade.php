<div class="float-right">
    <ul class="nav nav-tabs" role="tablist">
        <li class="dropdown active">
            <a class="dropdown-toggle btn" data-toggle="dropdown" aria-expanded="false">Action<b class="caret"></b></a>
                ...
                @if(Auth::user()->user_role == 1 )
                    ...
                    @elseif($contract->status == 6)
                       ...
                       <!--  <li><a class="btn btn-success" data-toggle="modal" data-target="#claimRefund">Claim Refund</a></li> -->
                        ...
                        <li><a class="btn btn-success" data-toggle="modal" data-target="#extend">Extend</a></li>
                        <li>
                    ...
                    @elseif($contract->status == 8 && isset($terminate->notice) && $terminate->notice == "BeforeTenancy")
                        <li><a href="{{ url('TerminateBT-Contract/'.$contract->id) }}" target="_blank" class="btn-success btn befor-tenancy">Termination request send</a></li>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" id="tenant_extend_contract" action="{{url('update-terminate-status/'.$contract->id)}}">
                @csrf
                <input type="hidden" name="refund_amount" id="refund_amount" value="{{$contract->deposit_amount}}">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <div class="col-md-10">
                            ...
                            @elseif($contract->deposit_amount <= 0)
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <span>{{$contract->deposit_amount}}</span>
                        </div>
                    </div>
                    <div class="form-group row">
