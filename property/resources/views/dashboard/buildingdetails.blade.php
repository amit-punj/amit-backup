        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="add-unit-main">
                            ...
                            <a class="btn btn-success" href="{{ url('edit-building/'.$buildingDetail->id) }}">Update Building</a>
                        </div>
                    </div>
                </div>  
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="add-unit-main">
                            <a class="btn btn-success" href="{{ url('create-property?building='.$buildingDetail->id)}}">Create Unit <span class="glyphicon glyphicon-plus"></span></a>
                        </div>
                    </div>
                </div> 
                <div class="row">
